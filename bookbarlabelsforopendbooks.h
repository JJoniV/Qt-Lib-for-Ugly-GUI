...
public:
    ...
    it look ugly but stays where you clicked (if you clicked in the middle your mouse stays in the middle) you calculater absolute positions - relative position
